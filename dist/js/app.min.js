...
var body=$("html, body"),hamburger=$(".hamburger"),mainNav=$(".main-nav"),mainHeader=$(".main-header"),headerHeight=mainHeader.outerHeight();hamburger.click(function(){mainNav.toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),body.toggleClass("body-modal-open"),mainNav.hasClass("nav-open")?body.bind("touchmove",function(e){$(e.target).parents().hasClass("nav-open")||e.preventDefault()}):body.unbind("touchmove")}),$('a[href*="#"]').click(function(){$(".main-header").hasClass("open")&&($(".main-nav").removeClass("nav-open"),$(".main-header").removeClass("open"),$(".hamburger").removeClass("navOpen"),mainNav.hasClass("nav-open")||body.unbind("touchmove"))}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}});