...
var htmlBody=$("html, body"),hamburger=$(".hamburger"),mainNavigation=$(".main-nav"),mainHeader=$(".main-header"),headerHeight=mainHeader.outerHeight();hamburger.click(function(){mainNavigation.toggleClass("nav-open"),$(this).toggleClass("navOpen"),mainHeader.toggleClass("open"),htmlBody.toggleClass("body-modal-open")}),$('a[href*="#"]').click(function(){mainHeader.hasClass("open")&&(mainNavigation.removeClass("nav-open"),mainHeader.removeClass("open"),hamburger.removeClass("navOpen"),htmlBody.removeClass("body-modal-open"))}),mainHeader.headroom({offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}});