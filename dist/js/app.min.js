...
"use strict";var hamburger=$(".hamburger"),mainNavigation=$(".main-nav");hamburger.click(function(){mainNavigation.toggleClass("nav-open"),$(this).toggleClass("navOpen"),$(".main-header").toggleClass("open")});