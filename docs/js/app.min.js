...
var body=document.querySelector("html, body"),hamburger=document.querySelector(".hamburger"),mainNav=document.querySelector(".main-nav"),missionCircle=document.querySelector(".mission__circle"),technologyCircle=document.querySelectorAll(".technology__circle"),mainHeader=document.querySelector(".main-header"),links=document.querySelectorAll("a[href*='#']"),headerHeight=mainHeader.offsetHeight,controller=new ScrollMagic.Controller,headroom=new Headroom(mainHeader,{offset:headerHeight,tolerance:{up:10,down:10},classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.classList.contains("open")&&mainHeader.classList.remove("unpinned")},onTop:function(){mainHeader.classList.remove("pinned")}});headroom.init(),document.ontouchmove=function(e){for(var n=!0,o=e.target;null!==o;){if(o.classList&&o.classList.contains("disable-scrolling")){n=!1;break}o=o.parentNode}n||e.preventDefault()},new ScrollMagic.Scene({triggerElement:missionCircle,offset:"-100"}).addTo(controller).on("enter",function(){missionCircle.classList.add("animated","hinge","fadeIn")}),new ScrollMagic.Scene({triggerElement:technologyCircle,offset:"-100"}).addTo(controller).on("enter",function(){technologyCircle.forEach(function(e){e.classList.add("animated","hinge","fadeIn")})}),hamburger.addEventListener("click",function(){mainNav.classList.toggle("nav-open"),this.classList.toggle("navOpen"),mainHeader.classList.toggle("open"),body.classList.toggle("body-modal-open"),body.classList.toggle("disable-scrolling")});for(var i=0;i<links.length;i++)links[i].addEventListener("click",function(e){mainNav.classList.contains("nav-open")&&(mainNav.classList.remove("nav-open"),mainHeader.classList.remove("open"),hamburger.classList.remove("navOpen"),body.classList.remove("body-modal-open"),body.classList.remove("disable-scrolling"))});